...
class Transmisor_AM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Transmisor_AM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Transmisor_AM")
        ...
        self._Ac_range = Range(0, 4, 0.0001, 0.1, 200)
        ...
        self._A_range = Range(0, 4, 0.00010, 1, 200)
        ...
        # Connections
        ##################################################
        self.connect((self.Envolvente_Compleja_DSB_SC_0, 0), (self.blocks_complex_to_mag_0, 0))
        self.connect((self.Envolvente_Compleja_DSB_SC_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.Envolvente_Compleja_DSB_SC_0, 0), (self.qtgui_time_sink_x_1, 0))
